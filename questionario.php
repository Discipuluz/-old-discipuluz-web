							...
							for($i = 0; $i <= 1; $i++){
								...
								foreach ($pdo->query($sql) as $row) {
										...
										."<div class='col-xs-12 form-card'>"
											."<span class='question-number'>".utf8_encode($row['orderId'])."</span>"
											."<br />"
											."<div class='col-xs-12 form-title'>".utf8_encode($row['question'])."</div>"
											."<div class='col-xs-1 form-field-arrow'></div>"
											."<fieldset id=group".utf8_encode($row['orderId'])." class='col-xs-12 form-radio'>"
												."<div class='form-radio-field'>"
													."<input type='radio' id='question".utf8_encode($row['orderId'])."-1' name='question".utf8_encode($row['orderId'])."'value='A' required/>"
													."<label for='question".utf8_encode($row['orderId'])."-1' class='col-xs-1 form-radio-button'>a</label>"
													."<label for='question".utf8_encode($row['orderId'])."-1' class='col-xs-11 form-radio-label'>".utf8_encode($row['alternativeA'])."</label>"
												."</div>"
												."<div class='form-radio-field'>"
													."<input type='radio' id='question".utf8_encode($row['orderId'])."-2' name='question".utf8_encode($row['orderId'])."'value='B' />"
													."<label for='question".utf8_encode($row['orderId'])."-2' class='col-xs-1 form-radio-button'>b</label>"
													."<label for='question".utf8_encode($row['orderId'])."-2' class='col-xs-11 form-radio-label'>".utf8_encode($row['alternativeB'])."</label>"
												."</div>"
											."</fieldset>"
										."</div>";
								}
